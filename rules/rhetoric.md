...
- The natural human calibration — hedging where genuinely uncertain, asserting where confident — is replaced by a flat assertive tone with ceremonial hedge phrases dropped in periodically
...
- If a summary is genuinely needed (long complex argument), make it add new value: a consequence, a question, a forward-looking statement — not a restatement
